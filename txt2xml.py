...
if __name__ == "__main__":
    ...
    parser.add_argument('--imgpath', type= str, default='./images')  # 原图文件夹路径
    parser.add_argument('--txtpath', type=str, default='./labels')   # 原txt标签文件夹路径
    parser.add_argument('--xmlpath', type=str, default='./Annotations')   # 保存xml文件夹路径
